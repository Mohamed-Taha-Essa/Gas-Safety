# 1 "ECU_LAYER/character_lcd/ecu_character_lcd.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "ECU_LAYER/character_lcd/ecu_character_lcd.c" 2
...
# 1 "ECU_LAYER/character_lcd/ecu_character_lcd.h" 1
# 12 "ECU_LAYER/character_lcd/ecu_character_lcd.h"
# 1 "ECU_LAYER/character_lcd/ecu_character_lcd_cfg.h" 1
# 12 "ECU_LAYER/character_lcd/ecu_character_lcd.h" 2

# 1 "ECU_LAYER/character_lcd/../../MCAL_LAYER/GPIO/hal_gpio.h" 1
# 13 "ECU_LAYER/character_lcd/../../MCAL_LAYER/GPIO/hal_gpio.h"
...
# 13 "ECU_LAYER/character_lcd/../../MCAL_LAYER/GPIO/../compiler.h"
...
# 13 "ECU_LAYER/character_lcd/../../MCAL_LAYER/GPIO/../compiler.h" 2
...
# 14 "ECU_LAYER/character_lcd/../../MCAL_LAYER/GPIO/../mcal_std_types.h" 2
...
# 14 "ECU_LAYER/character_lcd/../../MCAL_LAYER/GPIO/hal_gpio.h" 2
...
# 16 "ECU_LAYER/character_lcd/../../MCAL_LAYER/GPIO/hal_gpio.h" 2
# 40 "ECU_LAYER/character_lcd/../../MCAL_LAYER/GPIO/hal_gpio.h"
typedef enum {
    GPIO_LOW = 0 ,
    GPIO_HIGH
}logic_t;
...
# 13 "ECU_LAYER/character_lcd/ecu_character_lcd.h" 2
# 44 "ECU_LAYER/character_lcd/ecu_character_lcd.h"
typedef struct {
...
# 7 "ECU_LAYER/character_lcd/ecu_character_lcd.c" 2
...
# 28 "ECU_LAYER/character_lcd/ecu_character_lcd.c"
std_ReturnType lcd_4bit_intialize(const char_lcd_4bit_t *lcd){
...
# 71 "ECU_LAYER/character_lcd/ecu_character_lcd.c"
std_ReturnType lcd_4bit_send_command(const char_lcd_4bit_t *lcd, uint8 command){
    std_ReturnType ret = (std_ReturnType )0x01 ;
     if(((void*)0) == lcd )
      {
...
# 114 "ECU_LAYER/character_lcd/ecu_character_lcd.c"
std_ReturnType lcd_4bit_send_char_data(const char_lcd_4bit_t *lcd, uint8 data){
    std_ReturnType ret = (std_ReturnType )0x01 ;
     if(((void*)0) == lcd )
      {
...
# 150 "ECU_LAYER/character_lcd/ecu_character_lcd.c"
std_ReturnType lcd_4bit_send_char_data_pos(const char_lcd_4bit_t *lcd,uint8 row, uint8 column, uint8 data){
    std_ReturnType ret = (std_ReturnType )0x01 ;
     if(((void*)0) == lcd )
      {
...
# 174 "ECU_LAYER/character_lcd/ecu_character_lcd.c"
std_ReturnType lcd_4bit_send_string(const char_lcd_4bit_t *lcd, uint8 *str){
    std_ReturnType ret = (std_ReturnType )0x01 ;
     if(((void*)0) == lcd )
      {
...
# 202 "ECU_LAYER/character_lcd/ecu_character_lcd.c"
std_ReturnType lcd_4bit_send_string_pos(const char_lcd_4bit_t *lcd, uint8 row, uint8 column, uint8 *str){
    std_ReturnType ret = (std_ReturnType )0x01 ;
     if(((void*)0) == lcd )
      {
...
# 232 "ECU_LAYER/character_lcd/ecu_character_lcd.c"
std_ReturnType lcd_4bit_send_custom_char(const char_lcd_4bit_t *lcd, uint8 row, uint8 column,
                                         const uint8 _chr[], uint8 mem_pos){
    std_ReturnType ret = (std_ReturnType )0x01 ;
    uint8 l_counter =0 ;
...
# 302 "ECU_LAYER/character_lcd/ecu_character_lcd.c"
std_ReturnType lcd_8bit_send_command(const char_lcd_8bit_t *lcd, uint8 command){
    std_ReturnType ret = (std_ReturnType )0x01 ;
     if(((void*)0) == lcd )
      {
...
# 330 "ECU_LAYER/character_lcd/ecu_character_lcd.c"
std_ReturnType lcd_8bit_send_char_data(const char_lcd_8bit_t *lcd, uint8 data){
    std_ReturnType ret = (std_ReturnType )0x01 ;
     if(((void*)0) == lcd )
      {
...
# 360 "ECU_LAYER/character_lcd/ecu_character_lcd.c"
std_ReturnType lcd_8bit_send_char_data_pos(const char_lcd_8bit_t *lcd,uint8 row, uint8 column, uint8 data){
    std_ReturnType ret = (std_ReturnType )0x01 ;
     if(((void*)0) == lcd )
      {
...
# 383 "ECU_LAYER/character_lcd/ecu_character_lcd.c"
std_ReturnType lcd_8bit_send_string(const char_lcd_8bit_t *lcd, uint8 *str){
    std_ReturnType ret = (std_ReturnType )0x01 ;
     if(((void*)0) == lcd )
      {
...
# 410 "ECU_LAYER/character_lcd/ecu_character_lcd.c"
std_ReturnType lcd_8bit_send_string_pos(const char_lcd_8bit_t *lcd, uint8 row, uint8 column, uint8 *str){
    std_ReturnType ret = (std_ReturnType )0x01 ;
     if(((void*)0) == lcd )
      {
...
# 439 "ECU_LAYER/character_lcd/ecu_character_lcd.c"
std_ReturnType lcd_8bit_send_custom_char(const char_lcd_8bit_t *lcd, uint8 row, uint8 column,
                                         const uint8 _chr[], uint8 mem_pos){
    std_ReturnType ret = (std_ReturnType )0x01 ;
    uint8 l_counter = 0 ;
...
# 467 "ECU_LAYER/character_lcd/ecu_character_lcd.c"
std_ReturnType convert_uint8_to_string(uint8 value, uint8 *str){
    std_ReturnType ret = (std_ReturnType )0x01 ;
     if(((void*)0) == str )
      {
...
# 490 "ECU_LAYER/character_lcd/ecu_character_lcd.c"
std_ReturnType convert_uint16_to_string(uint16 value, uint8 *str){
    std_ReturnType ret = (std_ReturnType )0x01 ;
     if(((void*)0) == str )
      {
...
# 513 "ECU_LAYER/character_lcd/ecu_character_lcd.c"
std_ReturnType convert_uint32_to_string(uint32 value, uint8 *str){
    std_ReturnType ret = (std_ReturnType )0x01 ;
     if(((void*)0) == str )
      {
...
# 536 "ECU_LAYER/character_lcd/ecu_character_lcd.c"
static std_ReturnType lcd_send_4bit (const char_lcd_4bit_t *lcd ,uint8 _data_command ){
    std_ReturnType ret = (std_ReturnType )0x01 ;
    uint8 l_bit_position = 0 ;
    for(l_bit_position = 0 ;l_bit_position <4 ;l_bit_position++){
...
# 569 "ECU_LAYER/character_lcd/ecu_character_lcd.c"
static std_ReturnType lcd_send_8bit (const char_lcd_4bit_t *lcd ,uint8 _data_command ){
    std_ReturnType ret = (std_ReturnType )0x01 ;
    uint8 l_bit_position = 0 ;
    for(l_bit_position = 0 ;l_bit_position < 8 ;l_bit_position++){
    ret = gpio_pin_write_logic(&(lcd->lcd_data[l_bit_position]) ,(_data_command >> l_bit_position) & (uint8)0x01);
    }
         return ret ;
...
# 604 "ECU_LAYER/character_lcd/ecu_character_lcd.c"
static std_ReturnType lcd_8bit_set_cursor (const char_lcd_8bit_t *lcd , uint8 row , uint8 column){
        std_ReturnType ret = (std_ReturnType )0x01 ;
    column--;
...
# 628 "ECU_LAYER/character_lcd/ecu_character_lcd.c"
static std_ReturnType lcd_4bit_set_cursor (const char_lcd_4bit_t *lcd , uint8 row , uint8 column){
        std_ReturnType ret = (std_ReturnType )0x01 ;
    column--;
    switch(row){
