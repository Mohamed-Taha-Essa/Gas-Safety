...
std_ReturnType keypad_initialize(const keypad_t *_keypad_obj){
    ...
    uint8 counter_row =0 ,counter_column= 0;
     if(((void*)0) == _keypad_obj )
      {
       ...
       {
         for(counter_row = 0 ; counter_row < 4 ; counter_row++)
         {
             ret = gpio_pin_initialize(&(_keypad_obj->keypad_row_pins[counter_row]));
         }
           for(counter_column = 0 ; counter_column < 4 ; counter_column++)
         {
     ...
     if((((void*)0) == _keypad_obj) || (((void*)0) == value))
      {
       ...
       {
             uint8 l_counter_row =0 ,l_counter_column= 0 ,l_counter=0 ;

         for(l_counter_row = 0 ; l_counter_row < 4 ; l_counter_row++)
         {
             ...
             for(l_counter_column = 0 ; l_counter_column < 4 ; l_counter_column++)
             {
