...
# 9 "MCAL_LAYER/Mcal_init.c" 2

# 1 "MCAL_LAYER/../project.h" 1
# 12 "MCAL_LAYER/../project.h"
# 1 "./ECU_LAYER/ecu_init.h" 1
# 12 "./ECU_LAYER/ecu_init.h"
# 1 "./ECU_LAYER/LED/led.h" 1
# 21 "./ECU_LAYER/LED/led.h"
typedef enum{
    LED_OFF,
    LED_ON
}led_status_t;
