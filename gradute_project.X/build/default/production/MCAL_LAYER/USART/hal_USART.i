...
# 40 "MCAL_LAYER/USART/../GPIO/hal_gpio.h"
typedef enum {
    GPIO_LOW = 0 ,
    GPIO_HIGH
}logic_t;
...
# 10 "MCAL_LAYER/USART/hal_USART.c" 2
...
static void EUSART_ASYNC_RX_INIT(const usart_t *_eusart) ;
    ...
    static void (*EUSART_framming_error_handler) (void)= ((void*)0) ;
    static void (*EUSART_over_interrupt_handler) (void)= ((void*)0) ;
...
std_ReturnType EUSART_ASYNC_WriteStringBlocking(uint8 *_data, uint16 str_len){
    ...
    if(((void*)0) ==_data ){
      ...
      for(count_str = 0 ; count_str < str_len ; count_str++){
...
# 277 "MCAL_LAYER/USART/hal_USART.c"
            ...
            else if ( 0 == _eusart->usart_tx_cfg.usart_tx_enable ){
                 PIE1bits.TXIE = 0;
            }
            else { }
...
# 325 "MCAL_LAYER/USART/hal_USART.c"
               (INTCONbits.GIE = 1);
               (INTCONbits.PEIE = 1);


            }
            else if ( 0 == _eusart->usart_rx_cfg.usart_rx_enable ){
                 PIE1bits.RCIE = 0 ;
            }
            else { }
