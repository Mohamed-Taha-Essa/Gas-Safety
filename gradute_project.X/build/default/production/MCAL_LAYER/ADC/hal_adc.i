...
# 40 "MCAL_LAYER/ADC/../GPIO/hal_gpio.h"
typedef enum {
    GPIO_LOW = 0 ,
    GPIO_HIGH
}logic_t;
...
static __attribute__((inline)) void adc_input_channel_port_configure(const adc_channel_select_t _channel );
static __attribute__((inline)) void select_result_format(const adc_conf_t *_adc );
static __attribute__((inline)) void select_voltage_refrence(const adc_conf_t *_adc );
...
static __attribute__((inline)) void adc_input_channel_port_configure(const adc_channel_select_t _channel ){
    switch(_channel){
            case ADC_CHANNEL_0 : (TRISA |= ((uint8)1 << 0x0));break;
            case ADC_CHANNEL_1 : (TRISA |= ((uint8)1 << 0x1));break;
            case ADC_CHANNEL_2 : (TRISA |= ((uint8)1 << 0x2));break;
            case ADC_CHANNEL_3 : (TRISA |= ((uint8)1 << 0x3));break;
            case ADC_CHANNEL_4 : (TRISA |= ((uint8)1 << 0x5));break;
            case ADC_CHANNEL_5 : (TRISA |= ((uint8)1 << 0x0));break;
            case ADC_CHANNEL_6 : (TRISA |= ((uint8)1 << 0x1));break;
            case ADC_CHANNEL_7 : (TRISA |= ((uint8)1 << 0x2));break;
            case ADC_CHANNEL_8 : (TRISA |= ((uint8)1 << 0x2));break;
            case ADC_CHANNEL_9 : (TRISA |= ((uint8)1 << 0x3));break;
            case ADC_CHANNEL_10: (TRISA |= ((uint8)1 << 0x1));break;
            case ADC_CHANNEL_11: (TRISA |= ((uint8)1 << 0x4));break;
            case ADC_CHANNEL_12: (TRISA |= ((uint8)1 << 0x0));break;
            default : ;
    }
}
...
static __attribute__((inline)) void select_voltage_refrence(const adc_conf_t *_adc ){
 ...
 else{do{ADCON1bits.VCFG1 = 0; ADCON1bits.VCFG0 = 0; }while(0);}
}
# 323 "MCAL_LAYER/ADC/hal_adc.c"
std_ReturnType ADC_Start_Conversion_Interrupt(const adc_conf_t *_adc ,adc_channel_select_t _channel){
