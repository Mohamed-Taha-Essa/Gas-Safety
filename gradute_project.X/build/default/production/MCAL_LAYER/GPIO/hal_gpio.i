...
std_ReturnType gpio_pin_get_direction_status(const pin_config_t *pin_config , direction_t *direc_status){
    std_ReturnType ret = (std_ReturnType )0x01 ;
    if(((void*)0) == pin_config || ((void*)0) == direc_status ||pin_config->pin > 8 -1)
    {
         ret = (std_ReturnType )0x00 ;
    }
    ...
    {
       *direc_status = ((*tris_registers[pin_config->Port] >> pin_config->pin) & ((uint8)1 )) ;
    }
     return ret ;
}
...
# 272 "MCAL_LAYER/GPIO/hal_gpio.c"
std_ReturnType gpio_port_toggle_logic(port_index_t port )
{
    std_ReturnType ret = (std_ReturnType )0x01 ;
    if ( port > 5 - 1)
