...
# 23 "./ECU_LAYER/7_segment/ecu_seven_segment.h"
typedef enum {
...
# 1 "./ECU_LAYER/../MCAL_LAYER/Mcal_init.h" 1
# 13 "./ECU_LAYER/../MCAL_LAYER/Mcal_init.h"
# 1 "./ECU_LAYER/LED/../../MCAL_LAYER/GPIO/../ADC/hal_adc.h" 1
# 13 "./ECU_LAYER/LED/../../MCAL_LAYER/GPIO/../ADC/hal_adc.h"
# 1 "./ECU_LAYER/LED/../../MCAL_LAYER/GPIO/../ADC/hal_adc_cfg.h" 1
# 13 "./ECU_LAYER/LED/../../MCAL_LAYER/GPIO/../ADC/hal_adc.h" 2

# 1 "./ECU_LAYER/LED/../../MCAL_LAYER/GPIO/../ADC/../Interrupt/mcal_interrupt_config.h" 1
# 15 "./ECU_LAYER/LED/../../MCAL_LAYER/GPIO/../ADC/../Interrupt/mcal_interrupt_config.h"
# 1 "./ECU_LAYER/LED/../../MCAL_LAYER/GPIO/../ADC/../Interrupt/mcal_interrupt_gen_cfg.h" 1
# 15 "./ECU_LAYER/LED/../../MCAL_LAYER/GPIO/../ADC/../Interrupt/mcal_interrupt_config.h" 2
# 56 "./ECU_LAYER/LED/../../MCAL_LAYER/GPIO/../ADC/../Interrupt/mcal_interrupt_config.h"
typedef enum {
...
# 104 "./ECU_LAYER/LED/../../MCAL_LAYER/GPIO/../ADC/hal_adc.h"
typedef enum {
    ADC_0_TAD = 0 ,
    ADC_2_TAD,
    ADC_4_TAD,
...
# 13 "./ECU_LAYER/../MCAL_LAYER/Mcal_init.h" 2
...
# 11 "./MCAL_LAYER/USART/hal_USART.h"
...
void ADC_DEFAULT_INTERRUPT_HANDLER(void){
 std_ReturnType ret = (std_ReturnType )0x00 ;
    ...
    if ((500 > adc_gas || 200 > adc_heat)){
           ret = gpio_pin_write_logic(&dc_pin_high ,GPIO_LOW);
         ret = led_off(&led_1);
        ret = gpio_pin_write_logic(&solenoid_pin_high ,GPIO_HIGH);
    }
    else{
        ret = led_on(&led_1);
        ret = gpio_pin_write_logic(&dc_pin_high ,GPIO_HIGH);
        ret = gpio_pin_write_logic(&solenoid_pin_high ,GPIO_LOW);
        counter++ ;
    }

     if (counter != 0 ){
                 ret = gsm_send_data_to_server(adc_gas,adc_heat);
                 counter = 0 ;
     }
     else{}
}
